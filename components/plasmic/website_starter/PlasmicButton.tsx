...
import { _useStyleTokens } from "./PlasmicStyleTokensProvider"; // plasmic-import: rmELHShWk6e5tA9aoasW9J/styleTokensProvider

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic.module.css"; // plasmic-import: rmELHShWk6e5tA9aoasW9J/projectcss
import sty from "./PlasmicButton.module.css"; // plasmic-import: CG5zk7Si0bEp/css

import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: ufAcAm7_K2gk/icon
import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: fonW9Up3fykF/icon
...
function PlasmicButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__osVkw, {
          [sty.freeBoxcolor_neutral__osVkwEz9Ua]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxroundedFull__osVkwnPw4U]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__osVkwcYjod]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__osVkwVaBb]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__osVkwiMdad]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__osVkw4Q8TK]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__osVkwAgrol]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_bordered_color_success__osVkwAgrolB7AFj]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox___70RI0, {
            [sty.freeBoxcolor_neutral___70RI0Ez9Ua]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft___70RI0Ez9UaHn73P]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart___70RI0V0UPz]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge___70RI0CYjod]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large___70RI0IMdad]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small___70RI04Q8TK]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered___70RI0Agrol]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___3U7VG)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___9XVGf, {
            [sty.freeBoxiconEnd___9XVGfaWmZp]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge___9XVGfcYjod]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large___9XVGfiMdad]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small___9XVGf4Q8TK]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__hgUwc)}
                role={"img"}
              />
            ),
